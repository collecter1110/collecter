...
class RankingSelectionWidget extends StatefulWidget {
  const RankingSelectionWidget({
    super.key,
  });

  @override
  State<RankingSelectionWidget> createState() => _RankingSelectionWidgetState();
}

class _RankingSelectionWidgetState extends State<RankingSelectionWidget> {
  @override
  void initState() {
    super.initState();
    initializeData();
  ...
  void initializeData() async {
    ...
    await rankingProvider.getRankingSelectionData();
  }
