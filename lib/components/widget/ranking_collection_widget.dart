...
class RankingCollectionWidget extends StatefulWidget {
  const RankingCollectionWidget({
    super.key,
  });

  @override
  _RankingCollectionWidgetState createState() =>
      _RankingCollectionWidgetState();
}

class _RankingCollectionWidgetState extends State<RankingCollectionWidget> {
  @override
  void initState() {
    super.initState();
    initializeData();
  ...
  void initializeData() async {
    ...
    await rankingProvider.getRankingCollectionData();
  }
        ...
        return (_collections!.isNotEmpty)
            ? GridView.builder(
                ...
                itemBuilder: (context, index) {
                  final CollectionModel collection = _collections[index];
                  return Collection(
                    routName: '/',
